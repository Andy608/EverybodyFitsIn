...
public class SnapSpotScript : MonoBehaviour
{
    ...
    public List<GameObject> noSnapList = new List<GameObject>();
    ...
    {
        //Runs through the noSnapList to see if the shape is valid
        foreach(GameObject shape in noSnapList) 
        {
            if (shape == selectedObj)
                return false;
        }
